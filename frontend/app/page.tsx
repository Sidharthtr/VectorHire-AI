...
const features = [
  {
    ...
    description: "Upload your PDF resume and get instant AI-powered skill extraction and profile building.",
  },
  {
    icon: Search,
    title: "Semantic Job Search",
    description: "Goes beyond keyword matching — find jobs that truly fit your experience using vector embeddings.",
  },
  {
    icon: TrendingUp,
    title: "Skill Gap Analysis",
    description: "Understand exactly which skills you're missing for your target roles and what to learn next.",
  },
  {
    icon: Zap,
    title: "Personalized Explanations",
    description: "Get clear, actionable explanations of why each job is or isn't the right fit for you.",
  },
];
    ...
    <div className="space-y-16">
      ...
      <section className="text-center py-16 space-y-6">
        ...
        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
          Upload your resume, discover perfectly matched AI jobs, and get a clear roadmap to land your dream role.
        </p>
